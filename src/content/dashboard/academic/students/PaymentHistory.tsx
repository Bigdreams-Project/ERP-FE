          ...
          {recentPayments.length === 0 ? (
            ...
            recentPayments.map((payment: Payment) => {
              ...
              return (
                <div
                  key={payment.id}
                  className="flex items-center justify-between p-5 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-indigo-50 hover:shadow-md transition-all duration-200"
                >
                  <div className="flex flex-col flex-1">
                    <span className="font-semibold text-gray-800 text-base mb-1">
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <button
                        ...
                        className="p-2.5 text-green-600 hover:bg-green-100 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        title="Download PDF"
                      ...
                      <button
                        ...
                        disabled={isPrinting}
                        className="p-2.5 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        title="Print Receipt"
