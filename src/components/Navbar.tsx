...
const Navbar = () => {
    return (
        <div className="flex items-center mt-[0.6rem] font-inter">

            <div className="w-[60%] flex items-center text-center gap-2  bg-[rgb(238,242,255)] py-[0.4rem] px-[0.8rem] rounded-full focus-within:outline-2 focus-within:outline-indigo-500 transition-all duration-200">

                <BiSearchAlt  className="text-[rgb(129,140,248)]"/>
