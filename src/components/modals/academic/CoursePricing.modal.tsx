import {
  ...
  ICenterFeeModalProps,
} from "@/types/academic/center.interface";
import { DollarSign, Maximize2, Minimize2, Plus, X } from "lucide-react";
import React from "react";
import { useForm } from "react-hook-form";

const CenterFeeModal: React.FC<ICenterFeeModalProps> = ({
  isOpen,
  onClose,
  onSave,
  isSaving,
  ...
  const onSubmit = (data: ICenterFeeAssignment) => {
    onSave(data);
    reset();
  };
