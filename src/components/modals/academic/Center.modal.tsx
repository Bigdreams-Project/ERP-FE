...
const CenterModal: React.FC<ICenterModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-65 flex items-center justify-center z-50 p-4 font-sans overflow-y-auto">
      <div className="relative bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-xl w-full max-w-3xl max-h-[95vh] overflow-hidden flex flex-col my-4">
        {/* Header */}
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 pb-6 border-b border-gray-200 dark:border-gray-700">
            {/* Name */}
            <div className="flex flex-col">
              <label
                htmlFor="name"
            ...
            <div className="flex flex-col relative">
              ...
              <span className="absolute right-3 top-[calc(1.75rem+4px)] text-gray-400 dark:text-gray-500 pointer-events-none">
                <ChevronDown size={18} />
              </span>
              {errors.location && (
                <p className="text-red-500 dark:text-red-400 text-xs mt-1">
          ...
          <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200 my-3 flex justify-between items-center">
            Financial Details
            <button
              type="button"
              onClick={() => appendBank(defaultBank)}
              className="flex items-center gap-1 text-xs font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors p-2 rounded-lg bg-blue-50 dark:bg-blue-900/20"
          ...
          {bankFields.map((field, index) => (
            <div
              key={field.id}
              className="p-4 mb-4 border border-gray-200 dark:border-gray-700 rounded-xl bg-gray-50 dark:bg-gray-700/50 relative"
            >
              {/* Remove Button */}
              {bankFields.length > 1 && (
                <button
                  ...
                  className="absolute top-2 right-2 p-1 text-red-500 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 transition-colors rounded-full bg-white dark:bg-gray-800 shadow-sm"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div className="flex flex-col relative">
                  ...
                  <input
                    ...
                    className="w-full h-10 px-4 text-sm text-gray-600 dark:text-gray-200 rounded-lg bg-white dark:bg-gray-700 border-2 border-transparent focus:border-blue-500 dark:focus:border-blue-400 focus:outline-none transition-colors"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            {/* Status */}
            <div className="flex flex-col relative">
              <label
                htmlFor="status"
          ...
          {/* Action Buttons */}
          <div className="mt-auto pt-4 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3 sticky bottom-0 bg-white dark:bg-gray-800">
            <button
              type="button"
              onClick={onClose}
